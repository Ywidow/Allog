    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6278), 1, new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6275), new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6277), new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6272), new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6276), 0 },
                    { 2, new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6280), null, 1, null, null, null, null, 3 },
                    { 3, null, new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6285), 2, new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6283), new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6284), new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6282), new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6283), 0 },
                    { 4, new DateTime(2023, 9, 15, 2, 42, 15, 485, DateTimeKind.Utc).AddTicks(6286), null, 2, null, null, null, null, 3 }
                });
