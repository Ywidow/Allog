...
public class CustomerContext : DbContext{
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder){
    ...
    customer
      .HasMany(customer => customer.Schedulings)
      .WithOne(scheduling => scheduling.Customer)
      .HasForeignKey(scheduling => scheduling.CustomerId);
    ...
    // Configurando as propriedades dos atributos da entidade "Order".
    ...
    order
      .Property(order => order.Observations)
      .HasMaxLength(45)
      .IsRequired();
    ...
    order
      .HasData(
        ...
        new Order{
          ...
          PaymentMethod =  PaymentMethod.CriptCoins,
    ...
    // Configurando as propriedades dos atributos da entidade "Customer".
    var scheduling =  modelBuilder.Entity<Scheduling>().UseTptMappingStrategy();

    scheduling
      .Property(scheduling => scheduling.Status)
      .IsRequired();
    ...
    scheduling
      .HasData(
        ...
        new Scheduling{
          Id = 2,
          Status = SchedulingStatus.Cancelated,
